                ...
                <form onSubmit={createTrip} className="space-y-3">
                    ...
                    <div className='h-14 px-5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2'>
                        ...
                        <input
                            type="text"
                            name="name"
                            placeholder="Seu nome completo" className="bg-transparent text-lg placehold-zinc-400 w-full outline-none" />
                    </div>
                    ...
                    <div className='h-14 px-5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2'>
                        ...
                        <input
                            type="email"
                            name="email"
                            placeholder="Seu e-mail pessoal" className=" bg-transparent text-lg placehold-zinc-400 w-full outline-none flex-1" />
                    </div>
